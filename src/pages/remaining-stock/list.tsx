...
export const RemainingStockProcessingList = () => {
    ...
    return (
        <List headerButtons={()=>false}>
            ...
            <Table {...tableProps} rowKey="id" rowSelection={{
                type: 'checkbox',
                ...
                <Table.Column
                    ...
                    render={(_, record: BaseRecord) => {
                        return (record.transfer? <Button type="dashed" onClick={()=>handleConfirmTransfer(record)}>Подвердит</Button>: <>
