        ...
        <Create saveButtonProps={saveButtonProps}>
            <Form {...formProps} layout="vertical">
                <Row gutter={16}>
                    ...
                    <Col span={6}>
                        <Flex align="flex-start" vertical style={{ margin: "0" }}>
                            <Form.Item label="Размеры (Д × Ш × В)" required>
                                <Input.Group compact>
                                    ...
                                    >
                                        <Input style={{ width: 100, textAlign: "center" }} placeholder="Длина" />
                                    </Form.Item>
                                    ...
                                    >
                                        <Input style={{ width: 100, textAlign: "center" }} placeholder="Ширина" />
                                    </Form.Item>
                                    ...
                                    >
                                        <Input style={{ width: 100, textAlign: "center" }} placeholder="Высота" />
                                    </Form.Item>
                                </Input.Group>
                            </Form.Item>
                        </Flex>
