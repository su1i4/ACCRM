...
import { Space, Table, Input, Button, Row, Col, DatePicker, Checkbox, Dropdown, Select, Form, Card, Modal,Image,  } from "antd";
import {
    SearchOutlined,
    FilterOutlined,
    CalendarOutlined,
...
import { FileOutlined, EditOutlined, UnorderedListOutlined, SyncOutlined } from "@ant-design/icons";
import React, { useState } from "react";
import {useMany, useNavigation, useUpdateMany,useShow} from "@refinedev/core";
    ...
    const handleBulkEdit = () => {
        ...
        if (selectedRowKeys && selectedRowKeys.length > 0) {
            ...
            updateMany({
                ...
                // @ts-ignore
                ids: selectedRowKeys,
                values: { /* новые значения для всех полей */ },
            });
            ...
            <Table {...tableProps} rowKey="id" onRow={(record) => ({
                ...
                <Table.Column
                    ...
                    render={(value, record, index) => {
                        ...
                        return record.counterparty?.clientPrefix +"-"+record.counterparty?.clientCode
                ...
                <Table.Column
                    ...
                    render={(value) => {
                        ...
                        const counterparty = counterpartyData?.data?.find((item) => item.id === value);
